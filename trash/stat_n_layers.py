...
def learning(n_input, n_hidden, n_classes, number_layers, input_data, output_data,
             learning_rate=0.001, training_epochs=100, display_step=10):
    # tf Graph input
    ...
    def generate_biases(n_hidden, n_classes, num):
        biases = {}
        for i in range(1, num + 1):
    ...
    prediction = multilayer_perceptron(x,
                                       ...
                                       generate_biases(n_hidden, n_classes, number_layers), number_layers)
...
def statistic(from_, to_, input_data, output_data, n_input=None, n_hidden=None, n_classes=None):
    if n_input is None:
        n_input = 20
    ...
    for i in range(from_, to_):
        statistic_.append(learning(n_input,
                                   n_hidden[0:i] if n_hidden is not None and len(n_hidden) > i else [n_input] * i,
                                   n_classes, i, input_data, output_data))
        print
        print
    return statistic_


print(statistic(2, 10, input_data, output_data1))
